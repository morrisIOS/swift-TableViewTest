...
private let NetworkRequestShareInstance = LZJNetWork()

class LZJNetWork {
    class var sharedInstance : LZJNetWork {
...
//    }
//}
extension LZJNetWork {
    //MARK: - GET 请求
    //    let tools : NetworkRequest.shareInstance!
    
    func getRequest(urlString: String, params : [String : Any], success : @escaping (_ response : Any)->(), failture : @escaping (_ error : Error)->()) {
...
//                    print(json)
    ...
    func lzjgetRequest(urlString: String, params : [String : Any], success : @escaping (_ response : [String : AnyObject])->(), failture : @escaping (_ error : Error)->()) {
